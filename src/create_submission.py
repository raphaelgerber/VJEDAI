"""Kaggle submission helpers: encode a depth map and write the CSV."""
...
def encode_depth(depth: np.ndarray) -> str:
    """Depth map -> base64(zlib(float16 bytes)), the competition's cell format."""
...
def save_submission(rows, out_csv="../submission.csv"):
    """Write rows [{id, Depths}, ...] to a Kaggle submission CSV."""
